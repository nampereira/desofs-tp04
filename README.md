...
This is a *detached fork of [OWASP Juice Shop](https://github.com/juice-shop/juice-shop)*, an insecure web application for security
trainings, awareness demos, CTFs and security tools guinea pig ! 
